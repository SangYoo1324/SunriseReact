...
function GenericItemList({ source = [], linkBaseAddress, imgParamName, hasThumbnail, staticImg, triggerModal }) {
// if linkBaseAddress is not provided, it will not be clickable and modal trigger function required

    const modalClicked = (sermonItem:SermonItem) => {
        console.log("modal clicked", sermonItem);
        triggerModal(sermonItem);
    }
