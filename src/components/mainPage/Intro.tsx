...
import { AddLocation, AutoStories, CalendarMonthRounded, ContactMailRounded, DocumentScannerRounded, EditCalendarRounded, Facebook, LocationCity, PhotoSizeSelectLarge, SourceRounded, YouTube } from '@mui/icons-material';
        ...
        <section>
            ...
            <div className="boot-container">
                ...
                transform transition-transform duration-200 hover:scale-105 cursor-pointer' style={{ backgroundImage: `url(${Nav2})` }}>
                            ...
                            {/* card3 */}
                            <Link to="/news#sermon" className='overflow-hidden hover:shadow-extra-dark'>
                                <div className='bg-center bg-cover rounded-lg flex justify-between items-center px-5 py-8 text-gray-100
